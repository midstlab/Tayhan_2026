...
This directory contains **conventional molecular dynamics (cMD) simulations** of CaM conformers selected from **free-energy minima identified in MetaD simulations**.  
